    ...
    <div class="">
        <div class="page-title">
            <div class="title_left">
                <h3>Asignar Materias al grupo {{$Grupo->codigo}}</h3>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="x_panel" style="">
                    <div class="x_title">
                        <h2>Favor sea muy cuidadoso al momento de asignar las Materias</h2>
                    ...
                    {!!Form::open(array('url'=>'assignmatter','method'=>'POST','autocomplete'=>'off'))!!}
                    {{Form::token()}}
                    <div class="x_content">
                                    ...
                                    <table id="datatable-checkbox"
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <input name="arraymaterias[]" value="{{$items->id}}" type="checkbox" id="check-all" class="flat">
                                                </td>
                                            </tr>
                                            @endforeach
                                        </tbody>
