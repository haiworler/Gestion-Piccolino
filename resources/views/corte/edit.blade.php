        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="x_panel" style="">
                    <div class="x_title">
                        <h2>Actualizar<small> Corte</small></h2>
                    ...
                    {!!Form::open(array('method'=>'PATCH','route'=>['corte.update',$Corte->id],'files'=>'true'))!!}
                    {{Form::token()}}
                    <div class="x_content">
                            <div class="col-md-6 col-sm-6 col-xs-12 form-group has-feedback">
                                <input type="text" class="form-control has-feedback-left" id="nombre" name="nombre"
                                    placeholder="Nombre Corte" required value="{{$Corte->nombre}}">
                                <span class="fa fa-barcode form-control-feedback left " aria-hidden="true"></span>
                            </div>
                        <div class="col-md-6 col-sm-6 col-xs-12 form-group has-feedback">
                                <select name="estado" id="estado" class="form-control ">
                                    @foreach ($Arrayestado as $items)
                                    @if($items == $Corte->estado)
